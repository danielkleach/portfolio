  ...
  return (
    <section id="contact" className="pt-16 md:pt-20 pb-8 md:pb-12 bg-[#fafafa]">
      <div className="container max-w-3xl px-4 md:px-0">
        ...
        >
          I&apos;m always open to discussing new opportunities or just having a chat about technology. Feel free to reach out through any of these platforms:
        </motion.p>
        ...
        >
          <a
            href="https://linkedin.com/in/daniel-leach-477a3847"
            target="_blank"
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <h3 className="font-semibold group-hover:text-teal-600 transition-colors">LinkedIn</h3>
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <h3 className="font-semibold group-hover:text-teal-600 transition-colors">GitHub</h3>
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <h3 className="font-semibold group-hover:text-teal-600 transition-colors">Twitter</h3>
                <p className="text-sm text-gray-500">Updates & Thoughts</p>
              </div>
            </div>
          </a>
          ...
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <h3 className="font-semibold group-hover:text-teal-600 transition-colors">Email</h3>
